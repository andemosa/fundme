...
const prefs = {
  ...
  redirect_url: "https://fundme-iota.vercel.app/oauth/callback",
  redirect_uri: "https%3A%2F%2Ffundme-iota.vercel.app%2Foauth%2Fcallback",
};

const getAccessToken = (code) =>
  axios
    .post(
      `https://auth.next.fractal.id/oauth/token?client_id=xzpETseMgXdmDa9wy51dpLP82I7grTZDf8LlAe922hs&client_secret=ex3KunauspnL-MJlMzeVxS508qUw9fgMWj-UcsyCEV4&code=${code}&grant_type=authorization_code&redirect_uri=https%3A%2F%2Ffundme-iota.vercel.app%2Foauth%2Fcallback`
    )
    .then((res) => res.data);
